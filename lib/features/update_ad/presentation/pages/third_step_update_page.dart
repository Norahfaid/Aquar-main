...
import '../../../annoncements/presentation/widgets/check_box_widget.dart';
import '../../../annoncements/presentation/widgets/check_container.dart';
...
class ThirdStepUpdateScreen extends StatefulWidget {
  final AnnounceData data;
  const ThirdStepUpdateScreen({super.key, required this.data});

  @override
  State<ThirdStepUpdateScreen> createState() => _ThirdStepUpdateScreenState();
}

class _ThirdStepUpdateScreenState extends State<ThirdStepUpdateScreen> {
  void removeFoucs() {
  ...
  Widget build(BuildContext context) {
    final bloc = context.watch<UpdateAnnoncementCubit>();
    return Form(
      key: bloc.formKey3,
      child: Column(
                                                ...
                                                children: [
                                                  Padding(
                                                    ...
                                                    child: InkWell(
                                                      onTap: () {
                                                        setState(() {
                                                          // bloc.initNetworkTypes(selectedNetWork: );
